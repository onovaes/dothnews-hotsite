...
async function processDirs() {
  ...
  const carouselFiles = ['dashboard', 'criar-post', 'posts-preview', 'posts', 'app-token', 'dois-fatores-seguranca', 'dispositivos-conectados', 'search-console-missing-urls', 'desempenho']
  console.log('\n[carousel slides — area-administrativa]')
